...
namespace UIGenerator
{
    ...
    public partial class DrawingArcForm : Form
    {
        ...
        /// </summary>
        private void NumericUpDown_StartingVerticalAngle_ValueChanged(object sender, EventArgs e) => info.StartingVerticalAngle = (int)NumericUpDown_StartingVerticalAngle.Value;
        /// <summary>
        /// EndingVerticalAngle変更
        /// </summary>
        private void NumericUpDown_EndingVerticalAngle_ValueChanged(object sender, EventArgs e) => info.EndingVerticalAngle = (int)NumericUpDown_EndingVerticalAngle.Value;
        /// <summary>
        /// テクスチャの変更
        /// </summary>
