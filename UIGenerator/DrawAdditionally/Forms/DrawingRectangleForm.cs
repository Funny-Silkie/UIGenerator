...
namespace UIGenerator
{
    ...
    /// </summary>
    public partial class DrawingRectangleForm : Form
    {
        private readonly MainEdittor main;
        private readonly DrawingRectangleInfo info;
        ...
        public DrawingRectangleForm(MainEdittor main, DrawingRectangleInfo info)
        {
        ...
        /// フォームが閉じられたときの挙動
        /// </summary>
        private void DrawingRectangleForm_FormClosed(object sender, FormClosedEventArgs e)
        {
